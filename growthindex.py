...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description='Choose top n best performing stocks.')
    # Add arguments
    parser.add_argument(
    ...
    return filename, pastn, rate, topn, initcapital, order, returnrate, tradecost, spread, verbose, startn


def main():
    filename, pastn, rate, topn, initcapital, order, returnrate, tradecost, spread, verbose, startn = get_args()
